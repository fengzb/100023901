...
2.  启动Fiber实现的echo程序；
3.  利用压测工具ab进行压测：ab -r -c 20000 -n 200000 [http://测试机IP地址:8080/][http_IP_8080]
...
![aebe9691be206fb88f45e4f763bcb7e9.png][]

如果你对Loom项目感兴趣，也想上手试一把，可以下载源代码自己构建，构建方法可以参考[Project Loom的相关资料][Project Loom]，不过需要注意的是构建之前一定要把代码分支切换到Fibers。
...
[http_IP_8080]: http://xn--IP-im8ckc884ihkivx9c:8080/
[aebe9691be206fb88f45e4f763bcb7e9.png]: https://static001.geekbang.org/resource/image/ae/e9/aebe9691be206fb88f45e4f763bcb7e9.png
